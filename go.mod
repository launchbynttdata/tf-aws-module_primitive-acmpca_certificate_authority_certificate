module github.com/launchbynttdata/tf-aws-module_primitive-acmpca_certificate_authority_certificate
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/rds v1.110.0 // indirect
